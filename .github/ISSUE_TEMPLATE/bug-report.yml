  ...
  - type: markdown
    attributes:
      value: |
        ...
        This issue tracker is for reporting reproducible bugs or regression's found in this package, if you have a question, please report it within the [Discussions tab](https://github.com/bbc/sqs-producer/discussions) instead.
